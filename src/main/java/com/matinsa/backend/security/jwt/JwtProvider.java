package com.matinsa.backend.security.jwt;
...
public class JwtProvider {
    ...
    public String refreshToken(JwtDto jwtDto) throws ParseException {
        try {
            Jwts.parserBuilder().setSigningKey(getSecret(secret)).build().parseClaimsJws(jwtDto.token());
        } catch (ExpiredJwtException e) {
            JWT jwt = JWTParser.parse(jwtDto.token());
